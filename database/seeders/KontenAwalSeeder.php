...
class KontenAwalSeeder extends Seeder
{
    ...
    {
        // Ambil semua gambar dari tabel images, di-index berdasarkan path
        // agar mudah dicari dengan $imageMap['nama_file.png']
        $imageMap = Image::all()->keyBy('path');

        // Helper closure untuk ambil image_id berdasarkan nama file
        $imgId = fn($filename) => optional($imageMap->get($filename))->id;
        ...
        $destinasi = [
            [
                ...
                'image_id'        => $imgId('unsplash_M8drGBgFNZE.png'),
                'durasi'          => '8 jam',
                'mood'            => 'Sunrise',
                'rating'          => '4.9',
                'label'           => 'Mulai pagi',
            ...
            [
                ...
                'image_id'        => $imgId('Tarian_Gandrung_sewu_03 1.png'),
                'durasi'          => '1 Hari',
                'mood'            => 'Festival',
                'rating'          => '4.9',
                'label'           => null,
            ...
            [
                ...
                'image_id'        => $imgId('unsplash_Souw06F1irM.png'),
                'durasi'          => '5 jam',
                'mood'            => 'Petualangan',
                'rating'          => '4.6',
                'label'           => null,
